...
from constants import TOKEN, DATABASE_MODE
...
class Bot(commands.Bot):
    ...
    def initialize(self) -> None:
        ...
        if not (DATABASE_MODE.lower() == "sql" or DATABASE_MODE.lower() == "json"):
            print(colour_message(message="Database mode is not set to 'sql' or 'json', aborting start", color="red"))
            return
